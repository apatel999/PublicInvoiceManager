...
@Component({
  selector: 'sales-audit',
  templateUrl: './sales-audit.component.html',
  styleUrls: ['./sales-audit.component.css']
})
export class SalesAuditComponent implements OnInit {
  public route: any;
